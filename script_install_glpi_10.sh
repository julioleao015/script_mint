...
#En-us
#GLPI 10 installation script, created to automate and facilitate the software implementation process.
#Please feel free to collaborate and cooperate for the development of this script.

#Pt-br
#Script de instalação do GLPI 10, criado para automatizar e facilitar o processo de implementação do software.
...
sleep 2
wget -O- https://github.com/glpi-project/glpi/releases/download/10.0.0/glpi-10.0.0.tgz | tar -zxv -C /var/www/html/
sleep 2
...
echo ""
echo "20. HABILITANDO SUPORTE AO TIMEZONE"
